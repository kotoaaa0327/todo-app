  ...
  return (
    <div className="relative min-h-screen">
      <div className="mx-auto max-w-3xl p-6 md:px-20">
        ...
        <div className="">
          {activeTab === "todo" && (
            <div className="bg-base-100 border border-base-300 rounded-box py-3 px-10 text-sm min-h-screen">
              {todoTasks.map((task) => {
                if (!task.isDone) {
                  return (
                    <TodoItem
          ...
          {activeTab === "done" && (
            <div className="bg-base-100 border border-base-300 rounded-box p-6 text-sm min-h-screen">
              {todoTasks.map((task) => {
                if (task.isDone) {
                  return (
                    <TodoItem
